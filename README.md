...
###### Please check out [this issue](https://github.com/NotStatilko/NonCipher/issues/6) before any use
...
```
primary_hash = password
for _ in range(iterations{1}):
    primary_hash = sha512(primary_hash + secret_word)
```
